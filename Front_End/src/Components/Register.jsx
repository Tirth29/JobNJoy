...
//   }
  ...
  return (
    <>
      ...
      <div className="h-screen w-full flex items-center justify-center bg-gradient-to-t from-violet-300 to-fuchsia-100">
        <form
          action="get"
          ...
          <div className="mt-8">
            ...
            <div className="bg-white mt-2 border-fuchsia-800 border-2 px-2 py-1 rounded-xl h-8">
              ...
              <input
                ...
                className="bg-transparent absolute border-1  ml-3 px-2 mb-1 rounded-xl"
              />
            </div>
